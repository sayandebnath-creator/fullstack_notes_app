  ...
  return (
    ...
    <MdClose className='text-xl text-slate-400' />
      ...
      <div className='flex flex-col gap-2 mt-4'>
        ...
        <textarea type="text" className='text-sm text-slate-950 bg-slate-50 p-2 rounded' placeholder='Content' rows={10} value={content} onChange={({ target }) => setContent(target.value)} />   
      </div>
